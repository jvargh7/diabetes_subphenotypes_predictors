...
# Identify undiagnosed DM based on A1c. Set agediagnosed_dm = current age, N = 261
...
# Exclude all DM to get no DM, N = 1562
...
### ARRIC Newly diagnosed dm: 2027 ###

#-------------------------------------------------------------------------
# Total sample (no T2D + new T2D), N = 3589, obs = 71962
